...
if __name__ == "__main__":
    ...
    high_round = HighCardRound(c1, c2)
    print("High card round winner:", high_round.resolve_round())  # → 1

    low_round = LowCardRound(c1, c2)
    print("Low card round winner:", low_round.resolve_round())    # → 2
